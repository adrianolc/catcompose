...
internal fun CatDetailContent(
    ...
    Box(
        ...
        TopAppBar(
            title = {},
            modifier = Modifier.statusBarsPadding(), // Add padding to account for the system status bar
            navigationIcon = {
            ...
            colors =
                TopAppBarDefaults.topAppBarColors(
                    containerColor = Color.Transparent, // Keep transparent to see the image behind
